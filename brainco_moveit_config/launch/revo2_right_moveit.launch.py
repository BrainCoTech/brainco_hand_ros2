"""
完整的 MoveIt demo launch 文件 - Revo2 Right Hand
启动 Revo2 右手的完整 MoveIt 演示环境（使用 FakeSystem）
...
def generate_launch_description():
    ...
    moveit_config = (
        ...
        .robot_description(file_path="config/revo2_right.urdf.xacro")
    ...
    ld.add_action(
        Node(
            ...
            parameters=[
                moveit_config.robot_description,
                str(moveit_config.package_path / "config/revo2_right_controllers.yaml"),
            ],
        )
    )
