...
typedef struct tagZCANCANFDData
{
  ...
  union
  {
    struct
    {
      ...
      UINT txDelay : 2;  // ���з�����ʱ, ������Ч. 0:�޷�����ʱ, 1:������ʱ��λms, 2:������ʱ��λ100us.
                         // ���ö��з�����ʱ����ʱʱ������timeStamp�ֶ�
      UINT transmitType : 4;  // ��������, ������Ч. 0:��������, 1:���η���, 2:�Է�����, 3:�����Է�����.
                              // �����豸֧���������ͣ�����������ο�����ʹ���ֲ�
      UINT
        txEchoRequest : 1;  // ���ͻ�������, ������Ч.
                            // ֧�ַ��ͻ��Ե��豸,��������ʱ����λ��1,�豸����ͨ�����սӿڽ����ͳ�ȥ������֡����,���յ��ķ�������ʹ��txEchoedλ���
      UINT txEchoed : 1;  // �����Ƿ��ǻ��Ա���, ������Ч. 0:�������߽��ձ���,
                          // 1:���豸���ͻ��Ա���.
      UINT reserved : 22;  // ����
    } unionVal;
    UINT rawVal;      // ֡��־λraw����
...
#define INVALID_CHANNEL_HANDLE 0
  ...
  Handle_chl * FUNC_CALL
  ZCAN_InitCAN(long handle, UINT can_index, ZCAN_CHANNEL_INIT_CONFIG & pConfig);
  ...
  UINT FUNC_CALL
  ZCAN_TransmitFD(Handle_chl & handle_chl, ZCAN_TransmitFD_Data * pTransmit, UINT len);
  ...
  UINT FUNC_CALL
  ZCAN_ReadChannelErrInfo(Handle_chl & handle_chl, ZCAN_CHANNEL_ERROR_INFO & errInfo);

  UINT FUNC_CALL ZCAN_GetReceiveNum(Handle_chl & handle_chl, BYTE type);

  UINT FUNC_CALL
  ZCAN_Receive(Handle_chl & handle_chl, ZCAN_Receive_Data * pReceive, UINT len, int wait_time);

  UINT FUNC_CALL
  ZCAN_ReceiveFD(Handle_chl & handle_chl, ZCAN_ReceiveFD_Data * pReceive, UINT len, int wait_time);
  ...
  UINT FUNC_CALL
  ZCAN_SetCANFDStandard(Handle_chl & handle_chl, UINT can_index, UINT canfd_standard);
